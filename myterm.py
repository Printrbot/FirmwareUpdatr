...
# Based on miniterm.py distributed with pyserial-2.7 under the following license:
...
DEFAULT_PORT = '/dev/tty.usbmodem12341'
...
def main():
    ...
    group.add_option("-g", "--gcode",
        dest = "gcode",
        help = "gcode file",
        default = '/tmp/printrbot.update.gcode'
    )
...
3: hex dump everything""",
    ...
    while True:
        ...
        miniterm.serial.write(line)
        miniterm.serial.write('\r\n')
        # Wait for output buffer to drain.
        miniterm.serial.flush()
    miniterm.serial.timeout = 5
    miniterm.serial.write('M501')
    miniterm.serial.write('\r\n')
